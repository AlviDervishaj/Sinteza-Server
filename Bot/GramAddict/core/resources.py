class ResourceID:
    def __init__(self, APP_ID):
        ...
        self.AYMH_RECYCLER_VIEW = f"{APP_ID}:id/aymh_recycler_view"
        ...
        self.FOLLOW_SHEET_MUTE_ROW = f"{APP_ID}:id/follow_sheet_mute_row"
        self.POSTS_MUTE_ROW = f"{APP_ID}:id/posts_mute_row"
        self.STORIES_MUTE_ROW = f"{APP_ID}:id/stories_mute_row"
        ...
        self.IGDS_HEADLINE_HEADLINE = f"{APP_ID}:id/igds_headline_headline"
        ...
        self.LEFT_BUTTON = f"{APP_ID}:id/left_button"
        self.LIKE_BUTTON = f"{APP_ID}:id/like_button"
        self.LIVE_BADGE_VIEW = f"{APP_ID}:id/live_badge_view"
        self.LANDING_CONTAINER = f"{APP_ID}:id/landing_container"
        self.LOG_IN_BUTTON = f"{APP_ID}:id/log_in_button"
        self.LOGIN_USERNAME = f"{APP_ID}:id/login_username"
        ...
        self.MESSAGECHECKBOX = f"{APP_ID}:id/messageCheckBox"
        self.NEGATIVE_BUTTON = f"{APP_ID}:id/negative_button"
        self.MESSAGE_CONTENT = f"{APP_ID}:id/message_content"
        ...
        self.PASSWORD = f"{APP_ID}:id/password"
        ...
        self.SIMILAR_ACCOUNTS_CONTAINER = f"{APP_ID}:id/similar_accounts_container"
        ...
        self.USER_DETAIL_FRAGMENT = f"{APP_ID}:id/user_detail_fragment"
        ...
        self.IS_PROFILE_VIEW = f"{self.USER_DETAIL_FRAGMENT}|{self.AYMH_RECYCLER_VIEW}"
