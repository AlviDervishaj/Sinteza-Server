    ...
    def __init__(self):
        ...
        self.arguments = [
            ...
            },
            {
                "arg": "--password",
                "nargs": None,
                "help": "password of the instagram account being used, needed only if account is not logged-in",
                "metavar": "abcd1234",
                "default": None,
            },
            {
                "arg": "--relog-after-block",
                "help": "logout and log back in if a block dialog is detected",
                "action": "store_true",
            },
            {
                "arg": "--relog-delay",
                "nargs": None,
                "help": "minutes the script will stop before re-login if a block popup appears",
                "metavar": "10-20",
                "default": "10-20",
            },
            {
            ...
            {
                "arg": "--can-recheck-after",
                "nargs": None,
                "help": "amount of hours that have to pass from the last check",
                "metavar": "24",
                "default": None,
            },
            {
            ...
            {
                "arg": "--change-source-if-crash",
                "help": "if there is a local crash, don't try again with the same target but move to the next one",
                "action": "store_true",
            },
            {
                "arg": "--timeout-startup",
                "nargs": None,
                "help": "time in minutes to wait for program to start",
                "metavar": "5-10",
                "default": "0",
            },
            {
            ...
            {
                "arg": "--mute-posts-after-follow",
                "help": "mute posts for just followed account",
                "action": "store_true",
            },
            {
                "arg": "--mute-stories-after-follow",
                "help": "mute stories for just followed account",
                "action": "store_true",
            },
        ]
