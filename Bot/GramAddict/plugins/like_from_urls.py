...
from GramAddict.core.interaction import browse_carousel, register_like
...
class LikeFromURLs(Plugin):
    ...
    def run(self, device, configs, storage, sessions, profile_filter, plugin):
        ...
        file_list = list(self.args.posts_from_file)
        shuffle(file_list)
                        ...
                        if already_liked:
                            ...
                            if media_type in (
                                ...
                                if media_type == MediaType.CAROUSEL:
                                    browse_carousel(self.device, obj_count)
                                opened_post_view.watch_media(media_type)
                                like_succeed = opened_post_view.like_post()

                            username, _, _ = post_view_list.post_owner(
